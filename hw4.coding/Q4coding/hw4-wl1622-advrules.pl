...
do(study(X)):-study(X),!.
do(toss(X)):-toss(X),!.  %Q4.8%%%%%%%%%%%%%%%%%%%%
do(hocus_pocus(X)):-hocus_pocus(X),!.  %Q4.9%%%%%%%%%%%%%%%%%%%%
do(quit):-quit,!.
...
location(doll, attic). %Q4.2%%%%%%%%%%%%%%%%%%%%
location(plate, attic). %Q4.2%%%%%%%%%%%%%%%%%%%%
location(teleporter, desk). %Q4.3%%%%%%%%%%%%%%%%%%%%
...
tossable(apple). tossable(computer).tossable(envelope).tossable(crackers).
tossable(stamp).tossable(doll).  %Q4.8%%%%%%%%%%%%%%%%%%%%
...
turn_off(Thing):- %Q4.6%%%%%%%%%%%%%%%%%%%%
  turned_on(Thing),  %Q4.6%%%%%%%%%%%%%%%%%%%%
  respond(['It is turned off']).  %Q4.6%%%%%%%%%%%%%%%%%%%%
turn_off(Thing):-  %Q4.6%%%%%%%%%%%%%%%%%%%%
  respond(['Turn on first']).  %Q4.6%%%%%%%%%%%%%%%%%%%%
...
can_take(Thing) :- %Q4.7%%%%%%%%%%%%%%%%%%%%
  have(Thing), %Q4.7%%%%%%%%%%%%%%%%%%%%
  respond(['You alreay took ', Thing]). %Q4.7%%%%%%%%%%%%%%%%%%%%
can_take(Thing) :-
  here(Place),
...
can_take(Thing) :- 
  ...
  location(Thing,X),
  location(X,Place).
can_take(Thing) :-   %Q4.10%%%%%%%%%%%%%%%%%%%%
  here(Place),       %Q4.10%%%%%%%%%%%%%%%%%%%%
  location(Thing,X), %Q4.10%%%%%%%%%%%%%%%%%%%%
  location(X, Y),    %Q4.10%%%%%%%%%%%%%%%%%%%%
  location(Y, Place). %Q4.10%%%%%%%%%%%%%%%%%%%% 
can_take(Thing) :-
  write("There is no "),
  write(Thing),
  write(" here."),
...
take_object(X):-
  ...
  nl.
takeImpossible(X):- %Q4.4%%%%%%%%%%%%%%%%%%%%
  respond(['Too heavy impossible to move ', X]). %Q4.4%%%%%%%%%%%%%%%%%%%%
...
toss(Thing):-  %Q4.8%%%%%%%%%%%%%%%%%%%%
  tossable(Thing), %Q4.8%%%%%%%%%%%%%%%%%%%%
  retract(have(Thing)),  %Q4.8%%%%%%%%%%%%%%%%%%%%
  respond(['You tossed ', Thing]).  %Q4.8%%%%%%%%%%%%%%%%%%%%
toss(Thing):- %Q4.8%%%%%%%%%%%%%%%%%%%%
  respond([Thing, ' is not tossable']). %Q4.8%%%%%%%%%%%%%%%%%%%%
hocus_pocus(Thing):- %Q4.9%%%%%%%%%%%%%%%%%%%%
  asserta(have(Thing)),
  respond([Thing, ' was added to your inventory by your magic ']).  %Q4.9%%%%%%%%%%%%%%%%%%%%
...
tran_verb(toss) --> [toss]. %Q4.8%%%%%%%%%%%%%%%%%%%%
tran_verb(hocus_pocus) --> [hocus, pocus]. %Q4.9%%%%%%%%%%%%%%%%%%%%
